...
def results():
    data = strategy_pattern3candlesticks.strategy_body()
    stats = strategy_pattern3candlesticks.run_bt(
        data, strategy_pattern3candlesticks)
    results = {}
...
if __name__ == "__main__":
    strategy_pattern3candlesticks.info()
    results()
