from halloween_backtesting import strategy_halloween


def results():
    strategy_halloween.info()
    data = strategy_halloween.strategy_body()
    stats = strategy_halloween.run_bt(data, strategy_halloween)
    results = {}
