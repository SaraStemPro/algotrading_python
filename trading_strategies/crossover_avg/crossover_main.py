from crossover_backtesting import strategy_crossover_avg


def results():
    strategy_crossover_avg.info()
    data = strategy_crossover_avg.strategy_body()
    stats = strategy_crossover_avg.run_bt(data, strategy_crossover_avg)
    results = {}
